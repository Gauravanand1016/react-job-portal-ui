...
const App = () => {
    ...
    const jobOpenings = [
    {
      brandLogo: "https://i.pinimg.com/1200x/9c/88/f2/9c88f2e23cd03a58b98869f8595a2775.jpg",
      companyName: "Google",
  ...
  return (
    <div className="parent">
      {jobOpenings.map(function(elem,idx){
        ...
        return <div key={idx}>
          <Card company={elem.companyName} post={elem.post} pay={elem.pay} brandLogo={elem.brandLogo} tag1={elem.tag1} tag2={elem.tag2} datePosted={elem.datePosted}/>
        </div>
      })}
    </div>
